...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nyxtools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14847&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nyxtools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nyxtools` can be installed with:

```
conda install nyxtools
```

It is possible to list all of the versions of `nyxtools` available on your platform with:
